...
impl MetadataCountExec {
    pub fn new(schema: SchemaRef, records: i64) -> Self {
...
impl DisplayAs for MetadataCountExec {
    fn fmt_as(&self, _t: DisplayFormatType, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "MetadataCountExec: records: {}", self.records)
    }
}
...
mod tests {
    ...
    fn test_metadata_count_exec_creates_single_count_row() {
        ...
        let exec = MetadataCountExec::new(schema, 42);
    ...
    fn test_metadata_count_exec_plan_name() {
        ...
        let exec = MetadataCountExec::new(schema, 7);
