...
#[openapi(
    paths(
        ...
        request::synthetics::list_monitors,
        request::synthetics::create_monitor,
        request::synthetics::get_monitor,
        request::synthetics::update_monitor,
        request::synthetics::delete_monitor,
        request::synthetics::set_monitor_enabled,
        request::synthetics::run_monitor_now,
        request::synthetics::list_locations,
        request::synthetics::list_results,
        request::synthetics::get_result,
        request::synthetics::get_artifact_url,
    ...
    components(
        schemas(
            ...
            // Synthetics
            config::meta::synthetics::Monitor,
            config::meta::synthetics::MonitorType,
            config::meta::synthetics::MonitorStatus,
            config::meta::synthetics::MonitorFrequency,
            config::meta::synthetics::MonitorFrequencyType,
            config::meta::synthetics::MonitorAuth,
            config::meta::synthetics::MonitorVariable,
            config::meta::synthetics::MonitorListItem,
            config::meta::synthetics::MonitorListResponse,
